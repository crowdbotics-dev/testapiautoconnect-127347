...
## Project Structure
    ...
    ├── testapiautoconnect_127347  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_127347`
...
2. Clone this repo and `cd testapiautoconnect_127347`
